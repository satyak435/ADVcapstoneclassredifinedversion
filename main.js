...
if(e.shiftKey==true && keyPressed=='80'){
    ...
    document.getElementById("width").innerHTML=block_width_image;
    document.getElementById("height").innerHTML=block_height_image;
}
...
function right(){
    if(player_x<=850){
        player_x=player_x+block_height_image;
        console.log("block image height="+block_height_image);
